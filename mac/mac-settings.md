...
```
sox -t coreaudio "BlackHole 2ch" -t raw -b 16 -e signed-integer -r 48000 -c 2 /tmp/snapfifo
...
snapserver.conf
lies in /opt/homebrew/etc/snapserver.conf
...
enabled = true
doc_root = opt/homebrew/share/snapserver/snapweb
port = 1780
...
#
[stream]
source = pipe:///tmp/snapfifo?name=macstream&sampleformat=48000:16:2
